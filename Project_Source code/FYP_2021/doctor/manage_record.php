                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" readonly type="text" name="p_id" value="<?php echo $data['p_id']?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" required="" rows="4" cols="50"  name="symp"><?php echo $data['symp'] ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" required="" rows="4" cols="50" name="presc"><?php echo $data['presc'] ?></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="p_status" id="patient_active" value="Checked" checked>
									<label class="form-check-label" for="patient_active">
									checked
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="p_status" id="patient_inactive" value="Unchecked">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit" name="btn">Edit Record</button>
                            </div>
                        </form>
                    </div>
                </div>
