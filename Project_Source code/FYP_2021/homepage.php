...
<div class="container">
    ...
    <div class="row min-vh-100 align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 pl-md-5 content" data-aos="fade-left">
            ...
            <a href="doctor/login.php"><button class="button" style="background-color: #278AE5; color: white">DOCTOR</button></a>

  <a style="margin-left: 20px;" href="receptionist/login.php"><button class="button"  style="background-color: #278AE5; color: white">RECEPTIONIST</button></a>
