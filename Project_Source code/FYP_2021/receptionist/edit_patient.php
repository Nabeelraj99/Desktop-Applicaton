 ...
 ?>
    ...
    $data = mysqli_fetch_array($run);
      if (isset($_POST['btn']))
      {
        ...
        $update="update patient_record set p_id='$patient_id',p_name='$patient_name',age='$patient_age',weight='$patient_weight',number='$patient_number',date='$patient_date',p_fee='$patient_fee',dob='$patient_dob',gender='$patient_gender',address='$patient_address' where id = '$uid'";
                        ...
                        <form method="post">
                            <div class="row">
								...
								<div class="col-sm-12">
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label>Address</label>
												<input type="text" class="form-control" name="p_address" value="<?php echo $data['address']?>">
											</div>
										</div>
								...
								<div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <input class="form-control" readonly type="text"  value="<?php echo $data['status']?>">
                                    </div>
                                </div>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit" name="btn">Edit Patient</button>
                            </div>
                        </form>
                    </div>
                </div>
