...
if(isset($_POST['btn']))
{
  ...
  $select = "select * from login where user_name = '$user' and password = '$pass'";
...
echo"<script >
 ...
 ?>
    ...
    <form  method="post">
        <img src="assets/img/rep.jpg"; style="height: 50; width: 200px; margin-left: 65px ">
        <h2 class="text-center">Receptionist</h2>       
